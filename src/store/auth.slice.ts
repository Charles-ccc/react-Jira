...
import { bootstrapUser, IAuth } from "context/auth-context";
...
// thunk，两层函数
export const login = (form: IAuth) => (dispatch: AppDispatch) =>
  auth.login(form).then((user) => dispatch(setUser(user)));

export const regiseter = (form: IAuth) => (dispatch: AppDispatch) =>
